    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="max-w-3xl text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl">
          ...
          <span className="text-amber-500">al siguiente nivel</span>
        </h1>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {steps.map((s) => (
              <div
                key={s.step}
                className="flex flex-col gap-4 rounded-xl border border-zinc-800 bg-zinc-900 p-8"
              >
                <span className="font-mono text-sm font-bold text-amber-500">
                  {s.step}
                </span>
                <s.icon className="size-8 text-amber-500" />
